...
// const { networkInterfaces } = import('os');
  ...
  map.on('load', async () => {
    ...
    async function getLocation(updateSource) {
      try {
        ...
        // const response = await fetch('http://10.3.133.133:5000/data', { method: 'GET' });
        const response = await fetch('http://192.168.43.184:5000/data', { method: 'GET' });
